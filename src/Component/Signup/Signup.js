...
class Signup extends PureComponent {
    constructor(props) {
        ...
        this.state = {
            ...
            inputValues: [
                {
                    value: "",
                    error: "First Name field cant be empty",
                    isError: false
                },
                {
                    value: "",
                    error: "Last Name field cant be empty",
                    isError: false
                },
                {
                    value: "",
                ...
                {
                    value: "",
                    error: "Password field cant be empty",
                    isError: false
                }
            ]
        }
    ...
    onSubmitClick = (event) => {
        ...
        // console.log('<------->', inputValues.filter(e => e.isError === true).length);
        ...
        if (!(updatedInputValues.filter(input => input.isError === true).length)) {
            const userDetail = {
                ...
                Password: updatedInputValues[3].value
            }
                ...
                <div className="modal-content">
                    ...
                    <form className="signup-box" onSubmit={this.onSubmitClick}>
                        <div className="signup-box-container">
                            ...
                            <input className="signup-box-inputBox" placeholder="Enter your First Name" value={this.value} onChange={(e) => this.onChange(e)} />
                        </div>
                        <div className="error-message">{inputValues[0].isError && inputValues[0].error}</div>
                        <div className="signup-box-container">
                            <i className="fa fa-phone icon" aria-hidden="true"></i>
                            <input className="signup-box-inputBox" placeholder="Enter your Last Name" value={this.value} onChange={(e) => this.onChange(e)} />
                        </div>
